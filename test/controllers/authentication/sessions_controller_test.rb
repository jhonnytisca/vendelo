...
class Authentication::SessionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should login an user by email" do
    post sessions_url, params: { login: @user.email, password: '123123' }

    assert_redirected_to products_url
  end

  test "should login an user by username" do
    post sessions_url, params: { login: @user.username, password: '123123' }
  ...
  test "should logout" do
    ...
    assert_redirected_to products_url
    assert_equal flash[:notice], 'Sesión cerrada, hasta luego!'
